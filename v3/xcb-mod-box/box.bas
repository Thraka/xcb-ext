...
DIM SCREENBUFFER(1023) AS BYTE  
DIM COLORBUFFER(1023) AS BYTE
...
SUB screenSave() STATIC SHARED
	...
	MEMCPY SCREENRAM, @SCREENBUFFER, 1024
	MEMCPY COLORRAM, @COLORBUFFER, 1024
END SUB

SUB screenRestore() STATIC SHARED
	MEMCPY @SCREENBUFFER, SCREENRAM,  1024
	MEMCPY @COLORBUFFER, COLORRAM,  1024
END SUB
